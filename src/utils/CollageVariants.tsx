  ...
  9: [
    ...
    },
    {
      layout: [
        ...
        { x: 0.25, y: 0, width: 3 / 16, height: 0.5 },
        { x: 0.25 + 3 / 16, y: 0, width: 3 / 16, height: 0.5 },
        { x: 0.25 + 6 / 16, y: 0, width: 3 / 16, height: 0.5 },
        { x: 0.25 + 9 / 16, y: 0, width: 3 / 16, height: 0.5 },
        { x: 0.25, y: 0.5, width: 3 / 16, height: 0.5 },
        { x: 0.25 + 3 / 16, y: 0.5, width: 3 / 16, height: 0.5 },
        { x: 0.25 + 6 / 16, y: 0.5, width: 3 / 16, height: 0.5 },
        { x: 0.25 + 9 / 16, y: 0.5, width: 3 / 16, height: 0.5 },
      ],
      icon: (
        <SvgIcon
          layout={[
    ...
    {
      layout: [
        { x: 0, y: 0, width: 0.25, height: 1 / 3 },
        { x: 0.25, y: 0, width: 0.25, height: 1 / 3 },
        { x: 0.5, y: 0, width: 0.25, height: 1 / 3 },
        { x: 0.75, y: 0, width: 0.25, height: 1 / 3 },
        { x: 0, y: 1 / 3, width: 1 / 3, height: 1 / 3 },
        { x: 1 / 3, y: 1 / 3, width: 1 / 3, height: 1 / 3 },
        { x: 2 / 3, y: 1 / 3, width: 1 / 3, height: 1 / 3 },
        { x: 0, y: 2 / 3, width: 0.5, height: 1 / 3 },
