...
export const ADJUSTMENT_GROUPS: Record<string, AdjustmentGroup[]> = {
  ...
  color: [
    ...
    {
      label: 'modals.copyPaste.groups.colorGrading',
      keys: [
        'colorGrading',
        'colorGradingShadowsHue',
        'colorGradingShadowsSat',
        'colorGradingShadowsLum',
        'colorGradingMidtonesHue',
        'colorGradingMidtonesSat',
        'colorGradingMidtonesLum',
        'colorGradingHighlightsHue',
        'colorGradingHighlightsSat',
        'colorGradingHighlightsLum',
        'colorGradingBlending',
        'colorGradingBalance',
        'colorGradingGlobalHue',
        'colorGradingGlobalSat',
        'colorGradingGlobalLum',
      ],
    },
    {
      label: 'modals.copyPaste.groups.colorMixer',
      keys: [
        'hsl',
        'hslRedsHue',
        'hslRedsSaturation',
        'hslRedsLuminance',
        'hslOrangesHue',
        'hslOrangesSaturation',
        'hslOrangesLuminance',
        'hslYellowsHue',
        'hslYellowsSaturation',
        'hslYellowsLuminance',
        'hslGreensHue',
        'hslGreensSaturation',
        'hslGreensLuminance',
        ...
        'hslBluesLuminance',
        'hslPurplesHue',
        'hslPurplesSaturation',
        'hslPurplesLuminance',
        'hslMagentasHue',
        'hslMagentasSaturation',
