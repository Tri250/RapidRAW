...
const EXIF_TAG_ZH: Record<string, string> = {
  ...
  FNumber: '光圈',
  ExposureTime: '快门速度',
  PhotographicSensitivity: 'ISO感光度',
  ...
  CropRight: '裁剪右侧',
  CropBottom: '裁剪底部',
  AsShotNeutral: '拍摄时中性色',
  AsShotWhiteXY: '拍摄时白点',
  BaselineExposure: '基准曝光',
  BaselineNoise: '基准噪点',
  BaselineSharpness: '基准锐度',
  LinearResponseLimit: '线性响应极限',
  AnalogBalance: '模拟平衡',
  ShadowScale: '阴影缩放',
  HueAdjustmentDNG: '色相调整',
  CameraCalibration1: '相机校准1',
  CameraCalibration2: '相机校准2',
  CameraCalibrationSig: '相机校准签名',
  ...
  ReductionMatrix1: '缩减矩阵1',
  ReductionMatrix2: '缩减矩阵2',
  ColorMatrix1: '色彩矩阵1',
  ColorMatrix2: '色彩矩阵2',
};
...
function formatExifTag(str: string) {
  if (!str) return '';
  // Check Chinese translation map first
